...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    var window: UIWindow?
    var authLisener:AuthStateDidChangeListenerHandle?
    ...
    func autoLogin(){
        authLisener=Auth.auth().addStateDidChangeListener({ auth, user in
            Auth.auth().removeStateDidChangeListener(self.authLisener!)
